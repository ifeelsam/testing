...
# Removed unused import: from multiaddr import Multiaddr
...
async def test_webrtc_transport_end_to_end() -> None:
    async with trio.open_nursery() as nursery:
        ...
        add_protocol(
            Protocol(
                name="uEiBRYnd2NEs_2ycHGcld_M94-cKNOoLZamuSaGz_ArLaUA",
                code=293,
                codec=None,
            )
        )
        ...
        signal_webrtc_maddr = generate_webrtc_multiaddr(
            "192.168.0.1",
            str(peer_id),
            certhash="uEiBRYnd2NEs_2ycHGcld_M94-cKNOoLZamuSaGz_ArLaUA",
        )
